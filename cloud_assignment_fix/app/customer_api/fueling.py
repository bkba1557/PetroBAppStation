...
# EdgeAssignment reaches APPROVED when Cloud approval succeeds.  Older
# deployments may still carry ACTIVE, so customer fueling accepts both durable
# operational states instead of requiring the non-canonical legacy value.
